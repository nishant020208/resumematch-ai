...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ResumeMatch AI — On-device resume ↔ job matcher" },
      ...
      { property: "og:title", content: "ResumeMatch AI — On-device resume ↔ job matcher" },
      { property: "og:description", content: "Match score, keyword gap analysis, and rewrite suggestions — all running on your device." },
